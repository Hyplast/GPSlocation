...
data class SoundingDTO(
    ...
    data class WfsMember(
        ...
        @XmlSerialName("TrajectoryObservation","http://inspire.ec.europa.eu/schemas/omso/3.0","omso")
        val trajectoryObservation: TrajectoryObservation
    )
