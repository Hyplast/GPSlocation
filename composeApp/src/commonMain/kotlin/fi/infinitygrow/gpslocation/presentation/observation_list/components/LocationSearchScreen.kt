...
@Composable
fun LocationSearchWithSnackbar(
    locations: List<ObservationLocation>,
    observationLocations: MutableList<ObservationLocation>,
    ...
    LocationSearchScreen(
        ...
        onLocationSelected = { location ->
            scope.launch {
                snackbarHostState.showSnackbar(message = "${location.name} lisätty.")
            }
            onLocationSelected(location)
        },
...
fun LocationSearchScreen(
    ...
    Column(modifier = Modifier.fillMaxWidth()
        ...
        TextField(
            ...
            label = { Text("Etsi säähavaintoasemia") },
            modifier = Modifier
                .fillMaxWidth()
                .padding(16.dp)
        )
